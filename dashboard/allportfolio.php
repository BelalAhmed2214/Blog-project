              ...
              <div class="card-body">
                ...
                <?php foreach($data as $pro): ?>
                  <tr>
                    ...
                    <td><?= $pro['name'] ?></td>
                    <td><img src="upload/<?= $pro['image'] ?>" alt="img" height="200px"></td>
                    <td><a href="updateportfolio.php?pro_id=<?= $pro['id'] ?>" class="btn btn-primary" >Update</a></td>
                    <td><a href="deleteportfolio.php?pro_id=<?= $pro['id'] ?>" class="btn btn-danger">Delete</a></td>
                  </tr>
                <?php endforeach; ?>
                  </tbody>
                  <tfoot>
